...
#define STEPS_PER_MM_X 5.15f * MICRO_STEPPING
#define STEPS_PER_MM_Y 4.85f * MICRO_STEPPING

#define GANTRY_X_OFFSET_TO_A1 20
#define GANTRY_Y_OFFSET_TO_A1 20
...
#define MAGNET_SERVO_POSITION_UP 37
#define MAGNET_SERVO_POSITION_DOWN 125